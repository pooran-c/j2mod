...
public class SerialSlaveTest {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 *
			 * The file records from the TCP and UDP test harnesses are not included. They
			 * can be added if there is a need to test READ FILE RECORD and WRITE FILE
			 * RECORD with a Modbus/RTU device.
			 */
