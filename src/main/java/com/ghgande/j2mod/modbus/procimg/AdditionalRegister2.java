 ...
 */
public class AdditionalRegister2 extends SynchronizedAbstractAdditionalRegister2 implements Register {
	 ...
	 */
	public AdditionalRegister2(byte[] bytes) {
	 ...
	 */
	public AdditionalRegister2(int value) {
		setValue(value);
	}
