 ...
 * The emphasis is in making callas to Modbus devices as simple as possible for
 * the most common Function Codes. This class makes sure that no NPE is raised
 * and that the methods are thread-safe.
 *
...
public abstract class AbstractModbusMaster {
	 ...
	 *
	 * Note that the number of bits in the bit vector will be forced to the number
	 ...
	 *
	 * @throws ModbusException if an I/O error, a slave exception or a transaction
	 *                         error occurs.
	 */
	 ...
	 *
	 * Note that the number of input registers returned (i.e. array length) will be
	 ...
	 * @param register a <tt>Register</tt> holding the value of the register to be
	 *                 written.
	 *
	 ...
	 * @param registers a <tt>Register[]</tt> holding the values of the registers to
	 *                  be written.
	 *
	 ...
	 *
	 * @return true if success, i.e. response data equals to request data, false
	 *         otherwise.
	 *
	 * @throws ModbusException if an I/O error, a slave exception or a transaction
	 *                         error occurs.
	...
	/**
	 * Reads the response from the transaction If there is no response, then it
	 * throws an error
	 *
